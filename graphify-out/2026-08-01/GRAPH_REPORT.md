...
3. `AdaptivePacingEngine` - 6 edges
4. `WordTiming` - 6 edges
5. `SyncEngine` - 6 edges
6. `Document` - 5 edges
...
Cohesion: 0.11
Nodes (20): Graphify Always On Rule, Graphify Ingestion (Add URL), Obsidian Vault Export, Cross-Repo Graph Merge, CLAUDE.md Native Integration, Git Post-Commit Hook, Graph Traversal Modes, Constrained Vocabulary Expansion (+12 more)
...
### Community 2 - "Semantic Extraction Specification"
Cohesion: 0.50
...
Cohesion: 0.31
Nodes (7): DocumentParser, ParsedDocument, Option, Result, String, Vec, TextParser
