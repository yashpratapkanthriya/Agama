...
class AnalyticsView extends StatelessWidget {
  ...
  // CCI = avgWpm * quizAccuracy  (demo: 342 * 0.87 = 297.54)
  static const double _avgWpmDemo = 342.0;
  static const double _quizAccuracy = 0.87;
  double get _avgCci => _avgWpmDemo * _quizAccuracy; // 297.54
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _MetricCard(
                    label: 'Avg CCI',
                    value: _avgCci.toStringAsFixed(1),
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      // Normalise to 0–1 for the widget (max scale = 500)
                      value: (_avgCci / 500).clamp(0.0, 1.0),
                      minHeight: 10,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${_avgCci.toStringAsFixed(1)} / 450 target',
